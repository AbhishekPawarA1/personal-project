...
products.map((product) => {
    ...
    image.src = product.images[0]; // <img src="images[0]"/>
    ...
    let strikePrices=document.createElement("h2");
    strikePrices.textContent=product.strikePrice
    
    card.append(image, title, desc,prices,strikePrices);
